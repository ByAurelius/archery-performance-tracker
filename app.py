...
class Archer(db.Model):
    ...
    # YENI: Ekipman ayar gecmisi baglantisi
...
# YENI TABLO: Yay ince ayar (Tuning) gunlugu
...
# YENI ROUTE: Ekipman Ayarlari Ekleme Ekrani
...
# YENI ROUTE: Ekipman Ayarlari Listesi
